...
identity fix, the popout heartbeat leak, and the PDF-zoom auto-refit fix
are all entirely front-end; see the root CHANGELOG.md.
...
DrawingCanvas.tsx; see the root `CHANGELOG.md`.
